...
# Modified 01/10/2019 by Conrard Tetsassi to work with Networkx 2.x
# The networkx version MUST be in the 2.x series. Tested version: 2.5
...
if(nx.__version__ < '2.0'):
	...
	if(nx.__version__ > '2.5'):
		print("This script has been tested with NetworkX 2.5 .")
...
print("")
print("NOTE 2: Code tested with NetworkX 2.5. Your version:",nx.__version__)
print("")
